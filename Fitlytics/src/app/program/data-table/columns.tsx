  ...
  export const columns: ColumnDef<WorkoutExerciseDto>[] = [
    {
      ...
      cell: ({row}) => {
        ...
        if (selected) {
          return <ExerciseComboBox selected={row.original.exerciseName ?? ""}/>
        }
    ...
    },
    {
      ...
      cell: ({row}) => {
        ...
        if (selected) {
          return (
            <div className="flex justify-center items-center h-full">
              <Input type="text" id="working_sets_input" defaultValue={row.original.workingSets} className="w-[5rem] h-8 text-center"/>
            </div>
          )
        }
    ...
    },
    {
      ...
      cell: ({row}) => {
        ...
        if (selected) {
          return (
            <div className="flex justify-center items-center h-full">
              <Input type="text" id="load_input" defaultValue={row.original.weight ?? ""} className="w-[5rem] h-8 text-center"/>
            </div>
          )
        }
    ...
    },
    {
      ...
      cell: ({row}) => {
        ...
        if (selected) {
          return (
            <div className="flex justify-center items-center h-full">
              <Input type="text" id="percent_input" defaultValue={formatted ?? 0} className="w-[5rem] h-8 text-center"/>
            </div>
          )
        }
    ...
    },
    {
      ...
      cell: ({row}) => {
        ...
        if (selected) {
          return (
            <div className="flex justify-center items-center h-full">
              <Input type="text" id="rest_time_input" defaultValue={row.original.restTime ?? ""} className="w-[5rem] h-8 text-center"/>
            </div>
          )
        }
    ...
    },
    {
      ...
      cell: ({row}) => {
        ...
        if (selected) {
          return (
            <div className="flex justify-center items-center h-full">
              <Input type="text" id="actual_input" defaultValue={row.original.actualWeight ?? ""} className="w-[5rem] h-8 text-center"/>
            </div>
          )
        }
